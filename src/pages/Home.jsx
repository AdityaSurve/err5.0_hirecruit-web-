  ...
  return (
    <div>
      <div className="sm:grid grid-cols-2">
        <div className="flex flex-col text-3xl font-bold  justify-center items-center ">
          ...
          <div className="">
            <div className="flex justify-center items-center border-2 rounded-full my-3 p-1">
              ...
              />
              <div
                className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white p-3 rounded-full cursor-pointer "
        ...
        <div>
          <img
            src="http://get2.imglarger.com:8889/results/m0ICyKe6_4x.jpg"
            alt="/image"
          />
        </div>
      </div>
      ...
      <div className="flex justify-center items-center flex-col ">
        <div className="border-2 m-3 p-6 rounded-xl">
          ...
          <div className="flex flex-col overflow-y-scroll max-h-[500px]">
            {jobs.map((item) => {
              return <TrendingCard job={item.data()} />;
            }, [])}
          </div>
        </div>
      </div>
