            ...
            <div className="max-w-[900px] h-full   rounded-xl overflow-hidden shadow-2xl bg-white   justify-between items-center my-1 mx-1 p-3">
                <div className="px-6 py-4 flex flex-col items-center">
                    <div>
                        <img
                            ...
                            src={job.logo ? job.logo : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3nw5s4HDs_lXgQDN1fMiCv8qoE0pQsFIOCg&usqp=CAU"}
                            alt="Sunset in the mountains"
                        />
                    </div>
                    <div className="font-bold text-xl mb-0 mx-3">{job.title}</div>
                    <div className='font-semibold text-green-600 h-min mt-2  mb-2 text-sm bg-green-200 border-2 border-green-500 rounded-xl px-2'>{job.ename}</div>
                </div>
                {/* <div>
                ...
                <div className='flex flex-col justify-between'>
                    ...
                    <div className='flex w-full items-end justify-end'>
                        ...
                        ><Link to='/jobapplications/:jobid' className='text-white '>View Applicants</Link>
                        </button>
                    </div>
                </div>
            </div>
